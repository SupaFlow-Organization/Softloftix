    ...
    <div className="pt-20">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm animate-on-scroll">
        ...
        {/* Values */}
        <div className="mb-20">
          <h2 className="text-3xl md:text-4xl font-semibold font-geist text-white mb-12 text-center animate-on-scroll">Our Core Values</h2>
